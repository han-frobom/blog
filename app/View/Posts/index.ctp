...
<?php echo $this->Html->image('./posts/'.$post['Post']['imagePath'], array('alt' => 'Image', 'style' => 'width:202px;height: 199px;','class'=>'img-rounded','url'=>array('action' => 'view', $post['Post']['id'])))?>
